...
export class CitiesService {
   ...
   */
  async getAllCities(page = 1, limit = 50): Promise<{ cities: City[]; total: number }> {
  ...
  async seedCities(): Promise<void> {
    ...
    const cities = [
      ...
      { name: 'Hubli', state: 'Karnataka', latitude: 15.3647, longitude: 75.124 },
      ...
      { name: 'Bareilly', state: 'Uttar Pradesh', latitude: 28.367, longitude: 79.4304 },
      { name: 'Aligarh', state: 'Uttar Pradesh', latitude: 27.8974, longitude: 78.088 },
      { name: 'Moradabad', state: 'Uttar Pradesh', latitude: 28.8389, longitude: 78.7768 },
    ];
